...
SQL_DATASET_MAP: list[tuple[str, str, dict[str, str]]] = [
    ...
    (
        ...
        {"省份": "province", "城市": "city", "区县": "district", "服务量": "service_volume"},
    ),
    (
        r"gov_incidents",
        "demo-gov-incidents",
        {"事件类型": "incident_type", "数量": "count"},
    ),
    (
        r"gov_hotwords",
        "demo-gov-hotwords",
    ...
    (
        r"gov_budget_items",
        "demo-gov-budget",
        {"类别": "category", "支出金额": "spent_amount"},
    ),
    (
        r"gov_investment",
        "demo-gov-investment",
        {"产业": "industry", "投资额": "investment_amount"},
    ),
    (
        r"gov_service_metrics",
        "demo-gov-service",
        {"指标": "metric_name", "数值": "value"},
    ),
]
