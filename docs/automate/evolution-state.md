...
| pr_number | 78 |
| last_verified_command | cd backend && ruff check . && pytest ../tests/test_nfr_gov_conn_r51.py ../tests/test_nfr_gov_conn_r46.py ../tests/test_design_conn_gov_query_r49.py -q |
