...
- **验收标准**：
  ...
  - [x] **按人 IM 投递**（2026-08-13：钉钉/企微/飞书发给用户资料绑的账号；未绑号该通道失败且不回落群 webhook；`notifyGroup` 才发群机器人；`user_im_bindings` · Alembic `0047`）
