...
- **演化建议**：`tests/test_ingestion_l1_smoke.py` mock L1 成功/失败/历史排序 + `tests/test_doc_anchors_data.py` T-D05-05~07 锚点对账 + `analytics_sqlite` fixture；CI compose 跑 L1 integration（当前 skip）；L2 dataSourceId 登记见 M3/M4
