...
| 散点 | `renderScatter.ts` | perfRouter 采样 + canvas 混合 |
| 热力 | `renderHeatmap.ts` | 行列十字高亮 + tooltipLayer |
| 地图 | `renderChoropleth.ts` | hover 浮起 |
| 表格 | `VitalSpanTable.tsx` | 虚拟滚动、resize、密度档 |
