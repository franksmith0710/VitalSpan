...
> 更新：2026-07-03 · P5 r13 重评 DATA-003/002/ETL-001/004/001（M1B DATA companion 质量推分 r10）；pytest 162 + vitest 44 ingestion.smoke 19；测试覆盖 92–96%→94–98%，性能 76–82%→78–86%，ux 86%→88%，总分 85.4–88.1→87.5–89.5（均 <90）；远期未实现项仍占 Top10
...
| DATA-004 | 76 | 96 | 92 | N/A | 88 | 98 | 82 | 92 | 88.7 | 用户价值 |
| DATA-001 | 78 | 96 | 92 | N/A | 88 | 96 | 86 | 92 | 89.5 | 用户价值 |
| DATA-002 | 80 | 88 | 92 | N/A | 86 | 96 | 80 | 84 | 87.0 | 用户价值 |
| ETL-001 | 76 | 92 | 90 | N/A | 88 | 98 | 80 | 88 | 87.5 | 用户价值 |
| DATA-003 | 82 | 95 | 89 | 88 | 87 | 95 | 78 | 83 | 87.5 | 性能 |
| DATA-005 | 80 | 96 | 90 | N/A | 88 | 96 | 80 | 88 | 88.4 | 用户价值 |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 1.2.16 | 2026-07-03 | P5 r13 重评 DATA-003/002/ETL-001/004/001（M1B DATA companion 质量推分 r10）；pytest 162 + vitest 44；T-D04-11~13、T-D01-14~18、T-D02-13~15、T-L1-04、T-ETL-09~12、T-ING-14/16~19；测试覆盖 92–96%→94–98%，性能 76–82%→78–86%，ux 86%→88%，总分 85.4–88.1→87.5–89.5（均 <90） |
...
| 1.2.8 | 2026-07-03 | P5 r5 重评 BOOT-001~006（M1 plan §文档回写勾选闭环）；auth.md 补 `api/v1/me.py` 锚点、plan 4 行 `[x]`；BOOT-003 完整度 98%→100%，总分 86.0→86.4（仍 <90） |
| 1.2.7 | 2026-07-03 | P5 r4 重评 BOOT-001/002/004/005/006（M1 BOOT 测试 r4）；pytest 39 + fe 12；测试覆盖 68–82%→84–90%，安全 72–78%→78–82%，总分 82.4–86.1（仍 <90） |
| 1.2.6 | 2026-07-03 | P5 r3 重评 BOOT-001~006（M1 文档回写闭环）；services/core+auth 已实现、api/arch/F01 idempotent 对齐；完整度 86–94%→88–98%，总分 78.2–86.0（仍 <90） |
| 1.2.5 | 2026-07-03 | P5 r2 重评 BOOT-001~003/005~006（M1 BOOT 测试/security r2）；pytest 25 + vitest 6；测试覆盖 45–55%→68–82% |
