...
> 更新：2026-07-03 · P5 r19 重评 AUTH-001~005（M2 AUTH quality push r19）；pytest 348/4 skipped；T-AUTH-A01~A09、G11~G12、O11、R09、维度分页；绑定审计 + admin 守卫 + migration 0005；完整度 92–98%→96–98%，安全性 86–90%→88–90%，测试覆盖 98%→100%，总分 89.4–91.2→90.8–92.1（AUTH-003 审计闭环破 90，STUCK 清零）；远期未实现项仍占 Top10
...
| AUTH-001 | 82 | 98 | 96 | N/A | 90 | 100 | 86 | 88 | 91.5 | 用户价值 |
...
| AUTH-005 | 82 | 96 | 94 | N/A | 90 | 100 | 88 | 86 | 90.8 | 用户价值 |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 1.2.25 | 2026-07-03 | P5 r19 重评 AUTH-001~005（M2 AUTH quality push r19）；pytest 348/4 skipped；T-AUTH-A01~A09、G11~G12、O11、R09；auth_audit_events + GET /audit/events + admin binding guard + batch grant delete + org depth limit + dimension pagination；完整度 92–98%→96–98%，安全性 86–90%→88–90%，测试覆盖 98%→100%，总分 89.4–91.2→90.8–92.1（AUTH-003 审计闭环破 90 STUCK 清零） |
