...
> 更新：2026-07-07 · 规范见 `prd-scoring` · 本轮重评：META-001~004（92.3~93.7↑）
...
| 8 | VIZ-003 | 可视化项 | 90.1 | 用户价值 | 见期次 |
| 9 | VIZ-004 | 可视化项 | 90.1 | 用户价值 | 见期次 |
| 10 | VIZ-008 | 可视化项 | 90.1 | 用户价值 | 见期次 |
