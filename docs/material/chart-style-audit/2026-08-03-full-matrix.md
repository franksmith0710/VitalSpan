...
|-----------|------------------------|----------------|-----------|----------------|----------------|-----------|--------|
| gauge | variantBasic → background → palette → title → label → gaugeShape | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| liquid | background → palette → title → label → liquidShape | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
...
| waterfall | axis → cartesianShape → background → palette → title → remark → legend → label → tooltip | legend, label, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | p0-fixed |
...
| bar-range | axis → cartesianShape → background → palette → title → remark → label | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| bidirectional-bar | axis → cartesianShape → background → palette → title → remark → legend → label → tooltip | legend, label, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | p0-fixed |
| progress-bar | axis → cartesianShape → progressBarShape → background → palette → title → remark → label | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| stock-line | axis → stockLineShape → background → palette → title → remark → label | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | p0-fixed |
| bullet-graph | axis → cartesianShape → bulletShape → background → palette → title → remark → label | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| pie | pieShape → background → palette → title → remark → legend → label → tooltip | legend, label, conditional, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | seriesGradient 未接线（P0 已隐藏 UI）; paletteOpacity UI 已门控隐藏 | p1-backlog |
| pie-donut | pieShape → background → palette → title → remark → legend → label → tooltip | legend, label, conditional, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | paletteOpacity UI 已门控隐藏 | p0-fixed |
| pie-rose | pieShape → background → palette → title → remark → legend → label → tooltip | legend, label, conditional, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | paletteOpacity UI 已门控隐藏 | p0-fixed |
| pie-donut-rose | pieShape → background → palette → title → remark → legend → label → tooltip | legend, label, conditional, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | paletteOpacity UI 已门控隐藏 | p0-fixed |
| radar | background → palette → title → remark → label → radarShape | label, conditional, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| treemap | background → palette → title → remark → label → treemapShape | label, conditional, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| word-cloud | background → palette → title → wordCloudShape | remark | legend:missing; label:missing; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
| wordCloud (deprecated→word-cloud) | background → palette → title → wordCloudShape | remark | legend:missing; label:missing; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | deprecated→word-cloud; paletteOpacity UI 已门控隐藏 | p0-fixed |
| map | background → mapBasic → title → geo → remark | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | wired | hidden | profile 无 label 分区但 caps.label=true；2D 区域标签样式待决策 | p1-backlog |
| map-3d | background → title → geo → remark | label, remark | legend:missing; label:missing; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | — | ok |
| heatmap (deprecated→t-heatmap) | background → palette → title | label, remark | plugin-default | hidden | hidden | deprecated→t-heatmap; paletteOpacity UI 已门控隐藏 | ok |
...
| funnel | background → palette → title → legend → funnelShape | legend, label, conditional, remark | legend:wired; label:wired; dataZoom:missing; markLines:missing; conditional:wired | hidden | hidden | caps.label=true 无独立 label 分区（标签在 palette 内嵌）; paletteOpacity UI 已门控隐藏 | p1-backlog |
| sankey | background → palette → title → sankeyShape | remark | legend:missing; label:missing; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | caps 与 profile legend/label 分叉; paletteOpacity UI 已门控隐藏 | p1-backlog |
| circle-packing | background → palette → title → label → circlePackingShape | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | paletteOpacity UI 已门控隐藏 | ok |
...
| graph | variantBasic → background → palette → title → label → graphShape | label, remark | legend:missing; label:wired; dataZoom:missing; markLines:missing; conditional:missing | hidden | hidden | caps 与 profile legend/label 分叉; paletteOpacity UI 已门控隐藏 | p1-backlog |
