...
| GET | `/api/v1/datasources` | 数据源列表（M7 过滤） | IF-06 | 一期 | DS-002 | 已实现 | `backend/app/api/v1/datasources.py` |
...
| DELETE | `/api/v1/datasources/{id}` | 删除数据源 | IF-06 | 一期 | DS-002 | 已实现 | `backend/app/api/v1/datasources.py` |
| POST | `/api/v1/datasources/test` | 连通性测试（草稿配置） | IF-06 | 一期 | DS-003 | 已实现 | `backend/app/api/v1/datasources.py` |
| POST | `/api/v1/datasources/{id}/test` | 连通性测试（已保存） | IF-06 | 一期 | DS-003 | 已实现 | `backend/app/api/v1/datasources.py` |
