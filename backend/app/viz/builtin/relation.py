...
from app.viz.builtin._helpers import FLOW_RULE, GRAPH_RULE, PIE_RULE, SCATTER_RULE, antv

RELATION_SPECS = (
    antv("scatter", "散点图", "relation", field_rule=SCATTER_RULE),
    antv("quadrant", "象限图", "relation", field_rule=SCATTER_RULE),
    ...
    antv("multi-scatter", "多维散点图", "relation", field_rule=SCATTER_RULE),
