...
@patch(
    "app.ingestion.sync_executor.fetch_source_rows",
    return_value=[
...
@patch("app.ingestion.sync_executor.fetch_source_rows", side_effect=ConnectionError("mysql down"))
...
@patch("app.ingestion.sync_executor.fetch_source_rows", side_effect=ConnectionError("always fails"))
...
@patch("app.ingestion.sync_executor.write_analytics")
@patch("app.ingestion.sync_executor.fetch_source_rows", return_value=DIRTY_ORDERS_SUBSET)
...
@patch("app.ingestion.sync_executor.write_analytics")
@patch("app.ingestion.sync_executor.fetch_source_rows", return_value=[{"amount": "1"}])
