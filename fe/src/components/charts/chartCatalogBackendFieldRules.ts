...
export const BACKEND_CATALOG_FIELD_RULES: Record<string, BackendFieldRule> = {
  ...
  "table-normal": { minDimensions: 0, maxDimensions: 8, minMetrics: 0, maxMetrics: 8 },
  "table-pivot": { minDimensions: 0, maxDimensions: 8, minMetrics: 0, maxMetrics: 8 },
  ...
  "bar-range": { minDimensions: 1, maxDimensions: 8, minMetrics: 1, maxMetrics: 8 },
  "bidirectional-bar": { minDimensions: 1, maxDimensions: 2, minMetrics: 1, maxMetrics: 2 },
  "progress-bar": { minDimensions: 1, maxDimensions: 1, minMetrics: 1, maxMetrics: 1 },
  "stock-line": { minDimensions: 1, maxDimensions: 8, minMetrics: 1, maxMetrics: 8 },
  "bullet-graph": { minDimensions: 0, maxDimensions: 2, minMetrics: 1, maxMetrics: 3 },
  ...
  quadrant: { minDimensions: 1, maxDimensions: 2, minMetrics: 1, maxMetrics: 2 },
  ...
  "multi-scatter": { minDimensions: 1, maxDimensions: 2, minMetrics: 1, maxMetrics: 2 },
  ...
  "chart-mix-dual-line": { minDimensions: 1, maxDimensions: 8, minMetrics: 2, maxMetrics: 8 },
};
