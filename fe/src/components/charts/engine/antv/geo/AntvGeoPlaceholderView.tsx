...
/** 未配置时的中国地图轮廓占位（AntV 路径；对标 DataEase 图案地图） */
export function AntvGeoPlaceholderView({
  hint = DEFAULT_GEO_MAP_PLACEHOLDER_HINT,
  fill = false,
  height = 180,
  className,
  "data-testid": testId = "antv-map-chart",
}: Props) {
  return (
    <div
      className={cn(
...
export const GeoMapPlaceholderView = memo(AntvGeoPlaceholderView);
