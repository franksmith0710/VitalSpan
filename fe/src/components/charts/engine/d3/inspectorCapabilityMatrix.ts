...
const D3_WIRING_BY_TYPE: Record<string, D3InspectorFeatureMatrix> = {
  ...
  radar: { legend: "wired", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "wired" },
  ...
  "map-3d": { legend: "missing", label: "partial", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  ...
  "bidirectional-bar": { legend: "wired", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "progress-bar": { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "stock-line": { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
