...
const D3_WIRING_BY_TYPE: Record<string, D3InspectorFeatureMatrix> = {
  ...
  "chart-mix-dual-line": { ...PARTIAL_LEGEND, conditional: "missing" },
  scatter: { ...WIRED, conditional: "missing" },
  quadrant: { ...WIRED, conditional: "missing" },
  "multi-scatter": { ...WIRED, conditional: "missing" },
  ...
  treemap: { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "word-cloud": { legend: "missing", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  map: { legend: "missing", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  gauge: { legend: "missing", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  liquid: { legend: "missing", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  waterfall: { legend: "partial", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "bar-range": { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "bidirectional-bar": { legend: "partial", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "progress-bar": { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "stock-line": { legend: "missing", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "bullet-graph": { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  funnel: { legend: "partial", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "wired" },
  sankey: { legend: "missing", label: "missing", dataZoom: "missing", markLines: "missing", conditional: "missing" },
  "circle-packing": { legend: "missing", label: "wired", dataZoom: "missing", markLines: "missing", conditional: "missing" },
