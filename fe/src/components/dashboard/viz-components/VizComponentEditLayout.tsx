...
export function VizComponentEditLayout({ preview, rail }: VizComponentEditLayoutProps) {
  return (
    <div className="grid min-h-0 flex-1 gap-1.5 overflow-hidden lg:grid-cols-[minmax(0,1fr)_auto] lg:items-stretch [&>*]:min-h-0">
      <section
        className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.02]"
        data-testid="viz-component-edit-preview"
      >
        <div className="flex shrink-0 items-center border-b border-gray-100 px-3 py-1.5 dark:border-white/[0.06]">
          <p className="text-theme-xs font-medium text-gray-600 dark:text-gray-400">实时预览</p>
        </div>
        <div
