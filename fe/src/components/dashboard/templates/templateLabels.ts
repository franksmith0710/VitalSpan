...
export const BUILTIN_TEMPLATE_THUMBS: Record<string, string> = {
  ...
  "builtin-gov-smart-city": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-frost-clean-header.svg",
  "builtin-gov-digital-cockpit": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-paper-clean-header.svg",
  "builtin-gov-emergency-command": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-rose-clean-header.svg",
  "builtin-gov-eco-monitor": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-mint-clean-header.svg",
  "builtin-gov-community": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-lavender-clean-header.svg",
  "builtin-gov-efficiency": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-cloud-clean-header.svg",
  "builtin-gov-satisfaction": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-ivory-clean-header.svg",
  "builtin-gov-finance": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-mint-clean-header.svg",
  "builtin-gov-investment": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-paper-clean-header.svg",
  "builtin-gov-grid": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-cloud-clean-header.svg",
};
