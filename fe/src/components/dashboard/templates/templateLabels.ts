...
export const BUILTIN_TEMPLATE_THUMBS: Record<string, string> = {
  ...
  "builtin-gov-smart-city": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-slate-command.svg",
  "builtin-gov-digital-cockpit": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-indigo-command.svg",
  "builtin-gov-emergency-command": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-crimson-command.svg",
  "builtin-gov-eco-monitor": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-emerald-command.svg",
  "builtin-gov-community": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-violet-command.svg",
  "builtin-gov-efficiency": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-cloud-header-band.svg",
  "builtin-gov-satisfaction": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-ivory-header-band.svg",
  "builtin-gov-finance": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-mint-header-band.svg",
  "builtin-gov-investment": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-royal-command.svg",
  "builtin-gov-grid": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-paper-header-band.svg",
};
