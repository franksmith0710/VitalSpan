...
export const BUILTIN_TEMPLATE_THUMBS: Record<string, string> = {
  ...
  "builtin-dash-blank": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-frost-dot-matrix.svg",
  "builtin-dash-dual-kpi": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-frost-card-float.svg",
  "builtin-dash-triple-analysis": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-lavender-ribbon.svg",
  "builtin-dash-ops": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-cloud-watermark.svg",
  ...
  "builtin-gov-efficiency": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-cloud-dot-matrix.svg",
  "builtin-gov-satisfaction": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-lavender-watermark.svg",
  "builtin-gov-finance": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-mint-corner-fold.svg",
  "builtin-gov-investment": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-paper-header-band.svg",
  "builtin-gov-grid": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-ivory-dot-matrix.svg",
};
