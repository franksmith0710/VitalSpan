...
export const BUILTIN_TEMPLATE_THUMBS: Record<string, string> = {
  ...
  "builtin-gov-smart-city": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-cyan-command.svg",
  "builtin-gov-digital-cockpit": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-indigo-hud-scan.svg",
  "builtin-gov-emergency-command": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-crimson-aurora.svg",
  "builtin-gov-eco-monitor": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-emerald-circuit.svg",
  "builtin-gov-community": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-violet-honeycomb.svg",
  "builtin-gov-efficiency": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-cloud-header-band.svg",
  "builtin-gov-satisfaction": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-lavender-card-float.svg",
  "builtin-gov-finance": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-mint-ribbon.svg",
  "builtin-gov-investment": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-dark-royal-command.svg",
  "builtin-gov-grid": "/template-assets/packs/gov-enterprise-v1/thumbs/canvas-light-paper-watermark.svg",
};
